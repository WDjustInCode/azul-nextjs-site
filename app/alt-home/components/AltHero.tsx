      ...
      <div className={styles.heroContent}>
        <div className={styles.heroText}>
          <div className={styles.logoWrap}>
            ...
            >
              <defs>
                <radialGradient id="radial-gradient-combination-alt" cx="391.82" cy="132.19" fx="391.82" fy="132.19" r="245.54" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#bde4ff"/>
                  <stop offset="1" stopColor="#66b2ff"/>
                </radialGradient>
                <filter id="drop-shadow-1-combination-alt" x="123.43" y="12.88" width="523" height="223" filterUnits="userSpaceOnUse">
                  <feOffset dx="0" dy="0"/>
                ...
                <filter id="drop-shadow-2-combination-alt" x="442.43" y="18.88" width="102" height="94" filterUnits="userSpaceOnUse">
                  <feOffset dx="0" dy="0"/>
